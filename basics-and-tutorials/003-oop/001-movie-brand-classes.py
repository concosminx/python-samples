...
class Brand:
    ...
    def __getitem__(self, i): #use this with 'for model in dacia'
        return self.cars[i]

    def __repr__(self): #use this for a code oriented description
        return f'<Brand {self.cars}>'

    def __str__(self): #use this for an user oriented description
